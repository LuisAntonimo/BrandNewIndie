...
function createCard(game) { // cria um card baseado nos dados tirados do parâmetro
...
for (let i = 0; i < data.length; i++) { // cria os cards com base em cada item de data.js
  createCard(data[i]);
}
