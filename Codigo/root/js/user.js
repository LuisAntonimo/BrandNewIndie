...
function setTags() {
  const gameTags = ['action','adventure', 'battle-royale','beat-em-up','card-game','horror','metroidvania', 'moba','platformer', 'roguelike','rpg','shooter','simulation', 'stealth','strategy','survival']
  

  for (let i = 0; i < gameTags.length; i++) {
    const genreTag = gameTags[i];
